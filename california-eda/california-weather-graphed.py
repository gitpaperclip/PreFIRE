...
cal_weather_path = "resources\\california_100acre_fire_weather_data.csv"

location_data_lat_long = pd.read_csv(wildfire_data_path, usecols=['LATDD83', 'LONGDD83', 'TOTALACRES', 'DISCOVERYDATETIME', 'FIREOUTDATETIME', 'FIREYEAR']).dropna()
